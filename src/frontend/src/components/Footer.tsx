...
export default function Footer() {
  ...
  const appId = encodeURIComponent(window.location.hostname || "drsjc-studio");
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-12 max-w-4xl mx-auto bg-[#808000]/20 rounded-lg p-8">
          ...
          <div className="space-y-2 text-[#ff8c00] font-serif text-sm md:text-base leading-relaxed text-center md:text-left">
            <p>
              Professional Credentials (underpinning) Capability, Competency,
              and Mastery.
            </p>
            <p>Ph.D. in design and innovation (Human-centric).</p>
            <p>
              Master Degree in Adult Professional Development -- Leadership
              Studies.
            </p>
            <p>
              Undergrad degree in Computer Information Systems with minors in
            ...
            <p>
              Author of 50 riveting 'great‑reads' which transforms the mind, the
              intellect, the emotions, and the spiritual aspects of composite
              human existence.
            </p>
        ...
        <div className="text-center text-sm text-muted-foreground border-t border-border/50 pt-8">
          <p className="flex items-center justify-center gap-2">
            © {currentYear} The Doctor of UDesign (c)sm — Second‑2‑None Studios.
