...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-neon/20 rounded-full blur-3xl animate-glow-pulse"
      ...
      <div className="container mx-auto px-4 z-10 relative">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8 inline-block relative">
            ...
            <div
              className="absolute inset-0 bg-glow/30 rounded-full blur-2xl animate-glow-pulse"
            ...
            <div className="relative">
              ...
              <div
                className="absolute inset-0 rounded-full border border-accent/50 animate-pulse-ring"
          ...
          <div className="mb-8 max-w-3xl mx-auto neon-green-intro-box">
            ...
            <p className="text-base md:text-lg text-foreground leading-relaxed whitespace-pre-wrap px-4">
              Hello there, and welcome to my site. I am the Doctor of UDesign,
              owner, founder of '[[ Simply Shane Designs ]] (c)sm' I just wanted
              to take a few moments to welcome you to this site, to tell you how
              thrilled and electrified I am that you're actually here with us,
              and it is my desire, deepest desire, that the content that flows,
              that's attached, that's uploaded to this site will greatly benefit
              you. So stay connected, join the community. If you have any
              questions, feel free. Thank you very much. Let's begin.
            </p>
          </div>
          ...
          <div className="mb-3">
            <h2 className="text-2xl md:text-3xl font-serif font-semibold text-accent tracking-wide glow-text-subtle">
              ...
              <span className="text-lg align-super">(c)sm</span>
            </h2>
          </div>
          ...
          <p className="text-lg md:text-xl text-foreground/90 mb-8 max-w-2xl mx-auto leading-relaxed">
            Empowering minds through critical reasoning, problem-solving, and
            design thinking—committed to fostering intellectual excellence and
            creative innovation.
          </p>
