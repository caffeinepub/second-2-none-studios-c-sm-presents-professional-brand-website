              ...
              <CardContent className="pt-6 text-center">
                ...
                <div className="text-muted-foreground text-sm md:text-base space-y-4 text-left">
                  <p className="leading-relaxed">
                    "The greatest benefit of having a matured posture of self-identity is that the recipient will never find oneself sitting at the feet of another whom is less masterful than oneself."
                  </p>
                  
                  <p className="leading-relaxed">
                    Master key: For a (green belt) is very-very unlikely to teach/train a (black belt).
                  </p>
                  
                  <p className="leading-relaxed">
                    Golden takeaway point/principle: Master thyself and others will become innately aligned!" (Nicholls, J.S., December 12, 2025).
                  </p>
                </div>
              </CardContent>
            </Card>
